...
-- Public comments are intentionally exposed through this limited function rather
-- than direct table access, so visitors never receive member names or user IDs.
